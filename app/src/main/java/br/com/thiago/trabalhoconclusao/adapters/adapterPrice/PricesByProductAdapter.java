...
public class PricesByProductAdapter extends RecyclerView.Adapter<PricesViewHolder> {

    private List<Price> prices;
    private br.com.thiago.trabalhoconclusao.adapters.adapterPrice.OnItemClickListener viewListener, deleteListener;

    public PricesByProductAdapter(List<Price> prices, br.com.thiago.trabalhoconclusao.adapters.adapterPrice.OnItemClickListener viewListener, OnItemClickListener deleteListener) {
        this.prices = prices;
    ...
    public void onBindViewHolder(final PricesViewHolder holder, final int position) {
        ...
        StoreDAO dao = new StoreDAO(holder.itemView.getContext());
        Store store = dao.getStoreById(prices.get(position).getStore_id());
        ...
        String PriceImage = store.getImage_url();
